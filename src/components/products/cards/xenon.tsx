...
const Xenon: React.FC<XenonProps> = ({ product, className }) => {
  ...
  return (
    ...
    >
      <div
        className="relative flex items-center justify-center cursor-pointer h-[300px] sm:h-[350px] xl:h-[400px] bg-gray-100"
      ...
      <header className="p-3 md:p-6">
        <h3
          className="text-xs md:text-sm text-body font-semibold truncate cursor-pointer"
          onClick={handleProductQuickView}
        >
          {name}
        </h3>

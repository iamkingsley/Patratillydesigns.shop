...
import WhatsAppUs from '@components/whatsapp-us/whatsapp-us';
            ...
            {!!gallery?.length ? (
              ...
              <div className="w-full h-full flex items-center justify-center bg-light"
                style={{
                  ...
                  width: (size.width <= 500) ? '100%' : (size.width > 500 && size.width <= 767) ? '80vw' : '100%',
                  height: (size.width <= 500) ? '110vw' : (size.width > 500 && size.width <= 767) ? '100vw' : '100%',
